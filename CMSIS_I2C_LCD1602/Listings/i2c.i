...
void I2C_Init(void)
{
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR |= ((uint32_t)0x00000008) | ((uint32_t)0x00000001); 

		
		((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR |= ((uint32_t)0x00000002);
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH &= ~(((uint32_t)0x0000000C) | ((uint32_t)0x00000003) | ((uint32_t)0x000000C0) | ((uint32_t)0x00000030)); 
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH |= ((uint32_t)0x00000008) | ((uint32_t)0x00000080) |((uint32_t)0x00000004) | ((uint32_t)0x00000040); 
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH |= ((uint32_t)0x00000001) | ((uint32_t)0x00000010) |((uint32_t)0x00000002) | ((uint32_t)0x00000020); 
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR |= ((uint32_t)0x00200000); 
		...
		((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CCR = 180; 

	  ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1 = ((uint16_t)0x0001); 
    ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1 |= ((uint16_t)0x0400); 
		((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->OAR2 = ((uint8_t)0xFE);
}
