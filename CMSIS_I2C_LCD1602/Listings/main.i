...
{
		(((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL)) = ((((((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL))) & (~((0xFFFFFFUL )))) | (72000000U / 1000 - 1))));
		SysTick_CNT = ms;
		while(SysTick_CNT) {}
}
...
{
		(((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD)) = ((((((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD))) & (~((0xFFFFFFUL )))) | (72000000U / 1000 - 1))));
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL &= (0xFFFFFFUL );
		((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL) |= ((1UL << 2U) | (1UL ) | (1UL << 1U)));
}

void SetRCC_ClockTo72(void)
{
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CR |= ((uint32_t)0x00010000);
		while (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CR) & (((uint32_t)0x00020000) == RESET))) {}
		((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))-> ACR &= ~((uint8_t)0x10);
		((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))-> ACR |= ((uint8_t)0x10);
		((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))-> ACR &= ~((uint8_t)0x07);
		((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))-> ACR |= ((uint8_t)0x02);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CFGR &= ~((uint32_t)0x000000F0);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CFGR |= ((uint32_t)0x00000000);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CFGR &= ~((uint32_t)0x00003800);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CFGR |= ((uint32_t)0x00000000);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CFGR &= ~((uint32_t)0x00000700);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CFGR |= ((uint32_t)0x00000400);
		...
		while (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))-> CR) & (((uint32_t)0x02000000)))!= (((uint32_t)0x02000000))) {}
