...
void I2C_SendByteByADDR(I2C_TypeDef * i2c, uint8_t c,uint8_t addr)
{
  ...
  ((i2c->CR1) &= ~(((uint16_t)0x0800)));
  (((i2c->CR1)) = ((((((i2c->CR1))) & (~(((uint16_t)0x0400)))) | (((uint16_t)0x0400)))));
  ((i2c->CR1) |= (((uint16_t)0x0100)));
  while (!((i2c->SR1) & (((uint16_t)0x0001)))){};            
  (void) i2c->SR1;
  
  (((i2c->DR)) = ((((((i2c->DR))) & (~(((uint8_t)0xFF)))) | (addr | 0x00))));
  while (!((i2c->SR1) & (((uint16_t)0x0002)))){};
  (void) i2c->SR1;
  (void) i2c->SR2;
  
  (((i2c->DR)) = ((((((i2c->DR))) & (~(((uint8_t)0xFF)))) | (c))));
  while (!((i2c->SR1) & (((uint16_t)0x0080)))){};
  
  ((i2c->CR1) |= (((uint16_t)0x0200)));
}

void I2C_Init(void)
{
  
  ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) |= (((uint32_t)0x00000008)));
  ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL) |= (((uint32_t)0x80000000) | ((uint32_t)0x08000000) | ((uint32_t)0x40000000) | ((uint32_t)0x04000000) | ((uint32_t)0x20000000) | ((uint32_t)0x02000000) | ((uint32_t)0x10000000) | ((uint32_t)0x01000000)));

  
  ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) |= (((uint32_t)0x00200000)));
  
  tmpreg1 = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) & (((uint32_t)0x00200000)));
  
  ((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->OAR2) &= ~(((uint8_t)0x01)));
  
  ((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1) &= ~(((uint16_t)0x0040)));
  
  ((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1) &= ~(((uint16_t)0x0080)));
  
  ((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1) &= ~(((uint16_t)0x0001)));
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR2)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR2))) & (~(((uint16_t)0x003F)))) | (36))));
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->TRISE)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->TRISE))) & (~(((uint8_t)0x3F)))) | (11)))); 
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CCR)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CCR))) & (~((((uint16_t)0x8000) | ((uint16_t)0x4000) | ((uint16_t)0x0FFF))))) | (0x0000801E)))); 
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->OAR1)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->OAR1))) & (~(((uint16_t)0x0001) | ((uint16_t)0x00FE) | ((uint16_t)0x0300) | ((uint16_t)0x8000)))) | (0x00004000U))));
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1))) & (~(((uint16_t)0x0002) | ((uint16_t)0x0008) | ((uint16_t)0x0010)))) | (0x00000000U))));
  
  ((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1) |= (((uint16_t)0x0001)));
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1))) & (~(((uint16_t)0x0400)))) | (((uint16_t)0x0400)))));
  
  (((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->OAR2)) = ((((((((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->OAR2))) & (~(((uint8_t)0xFE)))) | (0))));
}
